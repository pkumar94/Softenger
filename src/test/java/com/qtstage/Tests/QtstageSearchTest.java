...
import com.qtstage.BusinessFlows.SearchProductFlow;
...
public class QtstageSearchTest {
	public WebDriver driver;

	@Parameters({ "browserType", "appURL", "tcID" })
	@Test
	public void tc_SearchProduct(String browserType, String appURL, String TC_ID) throws Throwable {
		try {
			...
			SearchProductFlow objAddToCartFlow = new SearchProductFlow();
			...
			objAddToCartFlow.searchProduct(driver, TC_ID);
			...
			e.getMessage();
			//driver.close();
			System.out.println("TC_AddToCart_Error");
		}
	}
}
